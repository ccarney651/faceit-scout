...
from owdb.match import SlotMatch, TemporalSmoother, modal_slot
...
def test_palette_hint_names_the_dead_side() -> None:
    ...
    from owdb.capture import palette_mismatch_hint
...
def test_confident_side_from_real_ocr_reads() -> None:
    from owdb.capture import confident_left_faction
...
def test_garbage_reads_are_refused_not_guessed() -> None:
    ...
    from owdb.capture import assign_sides, confident_left_faction
