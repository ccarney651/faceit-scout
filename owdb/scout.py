...
Pure orchestration over :mod:`owdb.analysis`: for each team it clusters the
...
def scout_payload(db: Any, faceit_db_path: str) -> dict[str, Any]:
    """The full owdb_comps.json payload: the existing per-team comp summary
...
def aggregate_swaps(
    ...
    *, per_map: bool = False,
    ...
    is never misreported as a tactical swap. See owdb/analysis.py's
