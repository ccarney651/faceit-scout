"""owdb's own SQLite database (``owdb.sqlite3``).

Separate file from ``faceit.sqlite3`` — non-negotiable (SPEC §3). owdb never
...
class Database:
    """Thin wrapper around the owdb SQLite connection.
    ...
    def code_age_summary(
        ...
        """Totals for ``owdb codes age``: latest wipe and how many stored
